...
var routes = [
  {
    ...
    children: [
      ...
      {
        path: path.LOGIN,
        loadComponent: () => import("./chunk-QCP3D4EQ.js").then((m) => m.LoginComponent)
      },
      {
        path: path.FORGOT_PASSWORD,
        loadComponent: () => import("./chunk-NDZTTX2H.js").then((m) => m.ForgotPasswordComponent)
      },
      {
        path: `${path.PASSWORD_RESET}/:token`,
        loadComponent: () => import("./chunk-KKYOHFMQ.js").then((m) => m.UpdatePasswordComponent)
      },
      {
...
//# sourceMappingURL=chunk-LGEJP4YS.js.map
